...
public class Prefixer {
	...
	public static int toInt(String s) {
		s = s.toLowerCase();
		if (s.equals("black")) { return 0; } //0
		if (s.equals("darkblue")) { return 1; } //1
		if (s.equals("darkgreen")) { return  2; } //2
		if (s.equals("darkaqua")) { return  3; } //3
		if (s.equals("darkred")) { return  4; } //4
		if (s.equals("darkpurple")) { return  5; } //5
		if (s.equals("gold")) { return  6; } //6
		if (s.equals("gray")) { return  7; } //7
		if (s.equals("darkgray")) { return  8; } //8
		if (s.equals("blue")) { return  9; } //9
		if (s.equals("green")) { return  10; } //10
		if (s.equals("aqua")) { return  11; } //11
		if (s.equals("red")) { return  12; } //12
		if (s.equals("pink")) { return  13; } //13
		if (s.equals("yellow")) { return  14; } //14
		if (s.equals("white")) { return  15; } //15
		return 15;
